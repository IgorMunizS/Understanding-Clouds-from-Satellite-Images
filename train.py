...
from utils.losses import dice_coef, dice_coef_loss_bce, lovasz_loss, combo_loss,active_countor_loss
...
def train(smmodel,backbone,batch_size,shape=(320,480),nfold=0,pseudo_label=None):
    ...
    for n_fold, (train_indices, val_indices) in enumerate(skf.split(mask_count_df.index, mask_count_df.hasMask)):
        ...
        if n_fold >= nfold:
            ...
            model = get_model(smmodel,backbone,opt,active_countor_loss,dice_coef,shape)
